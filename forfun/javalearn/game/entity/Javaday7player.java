package forfun.javalearn.game.entity;
...
public class Javaday7player extends Javaday7entity{
    forfun.javalearn.game.main.Javaday7panel gp;
    forfun.javalearn.game.main.Javaday7keyhandler keyH;

    public final int screenX;
    public final int screenY;

    public Javaday7player(forfun.javalearn.game.main.Javaday7panel gp, forfun.javalearn.game.main.Javaday7keyhandler keyH) {
        this.gp = gp;
        this.keyH = keyH;
